...
<head>
  ...
  <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
       ...
       <%
		  ...
		  String colorSettings1 = (String)request.getParameter("colors");
		  
		  if(colorSettings1 == null){
			  colorSettings1 = (String)session.getAttribute("colorSettings");
		  }
		  session.setAttribute("colorSettings",colorSettings1);
		  
   		//System.out.println("Color: " + value);
        if ("1".equals(colorSettings1)) {      	
    %>
    ...
    <%
        ...
        else if ("2".equals(colorSettings1)) {
    %>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><% out.println(nick); %></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <% out.println(nick); %> - Web Developer
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="admin/dashboard/users.jsp"><i class="fa fa-link"></i> <span>Users list</span></a></li>
